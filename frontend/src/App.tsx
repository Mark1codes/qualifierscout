...
const CITIES_BY_STATE: Record<string, string[]> = {
  ...
  "Arizona": ["Phoenix", "Tucson", "Mesa", "Chandler", "Gilbert", "Glendale", "Scottsdale", "Peoria", "Tempe", "Surprise", "Goodyear", "Yuma", "Avondale", "Flagstaff", "Casas Adobes", "Meridian", "Lake Havasu City", "Chandler Heights", "Apache Junction", "Maricopa", "Buckeye", "Oro Valley", "Prescott", "Bullhead City", "Prescott Valley", "Marana", "Casa Grande", "Sierra Vista"],
